import unittest
# from climate_scanner.trends_innovation_classifier.data_utils import build_trainingData
from data_utils import build_trainingData

class TestBuildTrainingData(unittest.TestCase):

    def test_build_trainingData(self):
        inputData = [{'id': 2,
                     ...
                     {'id': 4, 
                      ...
                      'category': 'Artificial Intelligence',
                      'climate_scanner': True}]
        result = build_trainingData(inputData)
        output = [{'id': 2,
                   'title': 'Artificial Intelligence Explained in Simple Terms',
                   'prev_id': [],
                   'prev_pos': [],
                  ...
                  {'id': 4,
                   ...
                   'prev_id': 1,
                   'prev_pos': (89, 196),
                   'prev_text': 'Articles about robots, technology, and the digital age may fill your head when you think about the term AI.',
                   'curr_id': 2,
                   'curr_pos': (197, 239),
                   'curr_text': 'But what is it really, and how is it used?',
                   'next_id': [],
                   'next_pos': [],
                   'next_text': '',
                   'category': 'Artificial Intelligence',
                   'climate_scanner': True}]
        self.assertEqual(result, output, "Valid Training Data")
